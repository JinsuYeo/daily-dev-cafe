...
public class ExControllerAdvice {
    ...
    public ResponseEntity httpRequestMethodNotSupportedExHandle(Exception e) {

        log.debug("Request method is not supported");
    ...
    public ResponseEntity serverErrorHandle(Exception e) {
        ...
        responseDto.setData(e.getClass() + " " + e.getMessage());
