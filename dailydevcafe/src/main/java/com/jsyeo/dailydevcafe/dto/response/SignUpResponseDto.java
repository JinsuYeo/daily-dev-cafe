...
public class SignUpResponseDto extends ResponseDto {
    ...
    public static ResponseDto duplicateEmail() {
        return new ResponseDto<>(HttpStatus.BAD_REQUEST.value(), "이미 존재하는 이메일입니다.", null);
    }

    public static ResponseDto duplicateNickname() {
        return new ResponseDto(HttpStatus.BAD_REQUEST.value(), "이미 존재하는 닉네임입니다.", null);
    }
}
