...
public class PostServiceTest extends ServiceTest {
    ...
    void getPostTest() {
        ...
        // given
        PublishPostRequestDto requestDto = createPublishPostRequestDto();
        PostDto requestPostDto = (PostDto) postService.publish(TEST_EMAIL, requestDto).getData();

        //when
        ResponseDto<? super PostDto> responseDto = postService.get(requestPostDto.getId());
